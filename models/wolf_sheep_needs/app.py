...
from model import WolfSheep, WolfSheepScenario
...
model_params = {
    ...
    "fear_decay": Slider("Sheep Fear Decay", 0.8, 0.1, 0.99, 0.01),
...
mortality_plot_component = make_plot_component(
    {
        "SheepStarved": "tab:purple",
        "SheepEaten": "tab:red",
        "StarvationRate": "tab:blue",
    },
    post_process=post_process_lines,
)
...
page = SolaraViz(
    model,
    renderer,
    components=[lineplot_component, mortality_plot_component, CommandConsole],
