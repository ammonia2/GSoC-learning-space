...
class WolfSheepScenario(Scenario):
    ...
    Args:
        ...
        fear_decay: Exponential decay weight for sheep fear state
        rng: Random rng
    """
...
class WolfSheep(Model):
    ...
    def __init__(self, scenario: WolfSheepScenario = WolfSheepScenario):
        ...
        model_reporters = {
            ...
            "SheepStarved": lambda m: m.sheep_starved,
            "SheepEaten": lambda m: m.sheep_eaten,
            "StarvationRate": lambda m: (
                m.sheep_starved / (m.sheep_starved + m.sheep_eaten)
                if (m.sheep_starved + m.sheep_eaten) > 0
                else 0.0
            ),
        }
        if self.grass:
        ...
        # Track sheep mortality causes for behavior/performance analysis
        ...
        Sheep.create_agents(
            ...
            * scenario.sheep_gain_from_food,
            ...
            fear_decay=scenario.fear_decay,
